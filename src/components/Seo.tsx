...
const defaultMeta = {
  title: 'Alice Anglesjö Portfolio',
  siteName: 'Portfolio',
  description: 'Frontend developer who likes to try out different technologies',

  url: 'https://alice-ang.vercel.app',
  type: 'website',
  robots: 'follow, index',
  image: 'https://alice-ang.vercel.app/images/large-og.png',
};
